...
protected:
	...
	pic16c62x_device(const machine_config &mconfig, device_type type, const char *tag, device_t *owner, const XTAL &clock, int program_width, address_map_constructor ram_map);
