...
g65sc02_device::g65sc02_device(const machine_config &mconfig, device_type type, const char *tag, device_t *owner, const XTAL &clock) :
	w65c02_device(mconfig, type, tag, owner, clock)
{
}

g65sc02_device::g65sc02_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock) :
	g65sc02_device(mconfig, G65SC02, tag, owner, clock)
{
}

g65sc12_device::g65sc12_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock) :
	g65sc02_device(mconfig, G65SC12, tag, owner, clock)
{
}

g65sc102_device::g65sc102_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock) :
	g65sc02_device(mconfig, G65SC102, tag, owner, clock)
{
}

g65sc112_device::g65sc112_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock) :
