...
intelfsh_device::intelfsh_device(const machine_config &mconfig, device_type type, const char *tag, device_t *owner, const XTAL &clock, uint8_t bits, uint32_t size, uint8_t maker_id, uint16_t device_id)
...
intelfsh8_device::intelfsh8_device(const machine_config &mconfig, device_type type, const char *tag, device_t *owner, const XTAL &clock, uint32_t size, uint8_t maker_id, uint16_t device_id)
	: intelfsh_device(mconfig, type, tag, owner, clock, 8, size, maker_id, device_id) { }

intelfsh16_device::intelfsh16_device(const machine_config &mconfig, device_type type, const char *tag, device_t *owner, const XTAL &clock, uint32_t size, uint8_t maker_id, uint16_t device_id)
...
fujitsu_29f160te_16bit_device::fujitsu_29f160te_16bit_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock)
...
atmel_29c020_device::atmel_29c020_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock)
...
macronix_29f1610mc_device::macronix_29f1610mc_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock)
	: intelfsh8_device(mconfig, MACRONIX_29F1610MC, tag, owner, clock, 0x200000, MFG_MACRONIX, 0xfa) { }

macronix_29f1610mc_16bit_device::macronix_29f1610mc_16bit_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock)
...
st_m29w640gb_device::st_m29w640gb_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock)
...
sst_39sf010_device::sst_39sf010_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock)
...
intel_28f640j5_device::intel_28f640j5_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock)
...
tc58fvt800_device::tc58fvt800_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock)
