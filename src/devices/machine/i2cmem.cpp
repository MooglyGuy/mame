...
i2c_24c128_device::i2c_24c128_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock) :
	i2cmem_device(mconfig, I2C_24C128, tag, owner, clock, 0, 64, 0x4000)
{
}

i2c_24c256_device::i2c_24c256_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock) :
