...
protected:
	...
	intelfsh_device(const machine_config &mconfig, device_type type, const char *tag, device_t *owner, const XTAL &clock, uint8_t bits, uint32_t size, uint8_t maker_id, uint16_t device_id);
...
protected:
	// construction/destruction
	intelfsh8_device(const machine_config &mconfig, device_type type, const char *tag, device_t *owner, const XTAL &clock, uint32_t size, uint8_t maker_id, uint16_t device_id);
};
...
protected:
	// construction/destruction
	intelfsh16_device(const machine_config &mconfig, device_type type, const char *tag, device_t *owner, const XTAL &clock, uint32_t size, uint8_t maker_id, uint16_t device_id);
};
...
{
public:
	atmel_29c020_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock = XTAL());
};
...
{
public:
	macronix_29f1610mc_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock = XTAL());
};
...
{
public:
	st_m29w640gb_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock = XTAL());
};
...
{
public:
	sst_39sf010_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock = XTAL());
};
...
{
public:
	fujitsu_29f160te_16bit_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock = XTAL());
};
...
{
public:
	intel_28f640j5_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock = XTAL());
};
...
{
public:
	tc58fvt800_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock = XTAL());
};
...
{
public:
	macronix_29f1610mc_16bit_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock = XTAL());
};
