...
i82443bx_host_device::i82443bx_host_device(const machine_config &mconfig, device_type type, const char *tag, device_t *owner, const XTAL &clock)
	: i82439hx_host_device(mconfig, type, tag, owner, clock)
{
}

i82443bx_host_device::i82443bx_host_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock)
...
i82443lx_host_device::i82443lx_host_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock)
...
i82443bx_bridge_device::i82443bx_bridge_device(const machine_config &mconfig, device_type type, const char *tag, device_t *owner, const XTAL &clock)
	: pci_bridge_device(mconfig, type, tag, owner, clock)
//  , m_vga(*this, finder_base::DUMMY_TAG)
{
}

i82443bx_bridge_device::i82443bx_bridge_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock)
...
i82443lx_bridge_device::i82443lx_bridge_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock)
