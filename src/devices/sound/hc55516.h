...
{
public:
	hc55516_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock = XTAL());
...
{
public:
	hc55532_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock = XTAL());
protected:
	// device-level overrides
	virtual void device_reset() override ATTR_COLD;
};
...
{
public:
	mc3417_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock = XTAL());
...
{
public:
	mc3418_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock = XTAL());
};
