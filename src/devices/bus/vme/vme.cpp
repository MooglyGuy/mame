...
vme_bus_device::vme_bus_device(machine_config const &mconfig, char const *tag, device_t *owner, const XTAL &clock, u8 datawidth)
...
vme_slot_device::vme_slot_device(machine_config const &mconfig, char const *tag, device_t *owner, const XTAL &clock)
