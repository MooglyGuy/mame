...
{
public:
	vme_sys68k_isio1_card_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock);

protected:
	vme_sys68k_isio1_card_device(const machine_config &mconfig, device_type type, const char *tag, device_t *owner, const XTAL &clock);
