...
public:
	...
	arc_scsi_oak_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock);
...
arc_scsi_oak_device::arc_scsi_oak_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock)
