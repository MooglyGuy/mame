...
public:
	...
	arc_hdisc_akd52_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock);
...
arc_hdisc_akd52_device::arc_hdisc_akd52_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock)
