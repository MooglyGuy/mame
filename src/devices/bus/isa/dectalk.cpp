...
void dectalk_isa_device::device_add_mconfig(machine_config &config)
{
	...
	TMS32015(config, m_dsp, XTAL::u(80'000'000)); // the a 20MHz oscillator is present - clock frequency hacked to make it "work"
	...
	DAC_12BIT_R2R_TWOS_COMPLEMENT(config, m_dac).add_route(0, "speaker", 1.0); // AD7541 DAC
}
