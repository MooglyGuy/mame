...
public:
	...
	apple2_wico_joystick_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock);
...
apple2_wico_joystick_device::apple2_wico_joystick_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock)
