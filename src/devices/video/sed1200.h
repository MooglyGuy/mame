...
public:
	sed1200d0a_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock);
...
public:
	sed1200f0a_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock);
...
public:
	sed1200d0b_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock);
...
public:
	sed1200f0b_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock);
