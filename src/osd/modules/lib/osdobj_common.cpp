...
const options_entry osd_options::s_option_entries[] =
{
	...
	{ OSDOPTION_BGFX_SCREEN_EFFECTS,             "",                core_options::option_type::STRING,   "comma-delimited list of screen effect JSON names, colon-delimited per-window" },
...
void osd_common_t::register_options()
{
	...
	REGISTER_MODULE(m_mod_man, RENDERER_D3D11); // this is only built for OSD=windows, there's no dummy stub
