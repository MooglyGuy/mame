...
GAME(1996,  abv106,  0,      capcom, capcom, capcom_state, empty_init, ROT0, "Capcom",           "Airborne (1.6)",             MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK)
GAME(1996,  abv105,  abv106, capcom, capcom, capcom_state, empty_init, ROT0, "Capcom",           "Airborne (1.5)",             MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK)
GAME(1996,  abv106r, abv106, capcom, capcom, capcom_state, empty_init, ROT0, "Capcom",           "Airborne (Redemption)",      MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK)
GAME(1996,  bbb109,  0,      capcom, capcom, capcom_state, empty_init, ROT0, "Capcom",           "Big Bang Bar (Beta 1.9 US)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK)
GAME(1996,  bbb108,  bbb109, capcom, capcom, capcom_state, empty_init, ROT0, "Capcom",           "Big Bang Bar (Beta 1.8 US)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK)
GAME(1996,  bsv103,  0,      capcom, capcom, capcom_state, empty_init, ROT0, "Capcom",           "Breakshot (1.3)",            MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK)
GAME(1996,  bsv102,  bsv103, capcom, capcom, capcom_state, empty_init, ROT0, "Capcom",           "Breakshot (1.2)",            MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK)
GAME(1996,  bsv100r, bsv103, capcom, capcom, capcom_state, empty_init, ROT0, "Capcom",           "Breakshot (Redemption 1.0)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK)
GAME(1996,  bsv102r, bsv103, capcom, capcom, capcom_state, empty_init, ROT0, "Capcom",           "Breakshot (Redemption 1.2)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK)
GAME(1996,  bsb105,  bsv103, capcom, capcom, capcom_state, empty_init, ROT0, "Capcom",           "Breakshot (Beta)",           MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK)
GAME(1996,  ffv104,  0,      capcom, capcom, capcom_state, empty_init, ROT0, "Capcom",           "Flipper Football (v1.04)",   MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK)
GAME(1996,  ffv103,  ffv104, capcom, capcom, capcom_state, empty_init, ROT0, "Capcom",           "Flipper Football (v1.03)",   MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK)
GAME(1996,  ffv101,  ffv104, capcom, capcom, capcom_state, empty_init, ROT0, "Capcom",           "Flipper Football (v1.01)",   MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK)
GAME(1996,  kpv106,  0,      capcom, capcom, capcom_state, empty_init, ROT0, "Capcom",           "Kingpin (Pinball)",          MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK)
GAME(1995,  pmv112,  0,      capcom, capcom, capcom_state, empty_init, ROT0, "Capcom",           "Pinball Magic",              MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK)
GAME(1995,  pmv112r, pmv112, capcom, capcom, capcom_state, empty_init, ROT0, "Capcom",           "Pinball Magic (Redemption)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK)
GAME(1994,  ghv101,  0,      capcom, capcom, capcom_state, empty_init, ROT0, "Romstar",          "Goofy Hoops",                MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK)
GAME(2000,  pp100,   bsv103, capcom, capcom, capcom_state, empty_init, ROT0, "Illinois Pinball", "Pool Player (1.0)",          MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK)
