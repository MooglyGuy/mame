...
void gal3_state::gal3(machine_config &config)
{
	...
	m68000_device &sound_cpu(M68000(config, "sound_cpu", XTAL::u(49152000)/4)); // ??
...
*/
	...
	C140(config, m_c140_16g, XTAL::u(49152000)/2304);
	...
	C140(config, m_c140_16a, XTAL::u(49152000)/2304);
