...
{
public:
	keycus_c406_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock = XTAL());
...
{
public:
	keycus_c409_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock = XTAL());
...
{
public:
	keycus_c410_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock = XTAL());
...
{
public:
	keycus_c411_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock = XTAL());
...
{
public:
	keycus_c430_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock = XTAL());
...
{
public:
	keycus_c431_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock = XTAL());
...
{
public:
	keycus_c432_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock = XTAL());
...
{
public:
	keycus_c442_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock = XTAL());
...
{
public:
	keycus_c443_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock = XTAL());
