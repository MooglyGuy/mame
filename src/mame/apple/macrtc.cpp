...
rtc3430042_device::rtc3430042_device(const machine_config &mconfig, device_type type, const char *tag, device_t *owner, const XTAL &clock, bool hasBigPRAM) :
...
rtc3430040_device::rtc3430040_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock) :
