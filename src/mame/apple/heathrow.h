...
public:
	...
	macio_device(const machine_config &mconfig, device_type type, const char *tag, device_t *owner, const XTAL &clock);
...
public:
	// construction/destruction
	grandcentral_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock);
...
public:
	// construction/destruction
	ohare_device(const machine_config &mconfig, device_type type, const char *tag, device_t *owner, const XTAL &clock);
	ohare_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock);
...
public:
	// construction/destruction
	heathrow_device(const machine_config &mconfig, device_type type, const char *tag, device_t *owner, const XTAL &clock);
	heathrow_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock);
...
public:
	// construction/destruction
	paddington_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock);
