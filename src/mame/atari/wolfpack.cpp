...
void wolfpack_state::wolfpack(machine_config &config)
{
	...
	S14001A(config, m_s14001a, XTAL::u(20'000)); // RC Clock (C=100pf, R=470K-670K ohms, adjustable) ranging from 14925.37313hz to 21276.59574hz, likely factory set to 20000hz since anything below 19500 is too slow
