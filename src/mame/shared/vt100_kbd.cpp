...
static INPUT_PORTS_START(ms7002)
	...
	PORT_BIT(0x02, IP_ACTIVE_LOW, IPT_KEYBOARD) PORT_NAME(u8"ЛАТ (Latin)") PORT_CODE(KEYCODE_HOME) PORT_CHAR(0x0f) // ЛАТ = латинские
	...
	PORT_BIT(0x08, IP_ACTIVE_LOW, IPT_KEYBOARD) PORT_NAME(u8"РУС  (Russian)") PORT_CODE(KEYCODE_END) PORT_CHAR(0x0e) // РУС = русские
	...
	PORT_START("LINE6")
	PORT_BIT(0x01, IP_ACTIVE_LOW, IPT_KEYBOARD) PORT_NAME(u8"О  O") PORT_CODE(KEYCODE_J) PORT_CHAR('o') PORT_CHAR('O')
	...
	PORT_BIT(0x40, IP_ACTIVE_LOW, IPT_KEYBOARD) PORT_NAME(u8"Н  N") PORT_CODE(KEYCODE_Y) PORT_CHAR('n') PORT_CHAR('N')
