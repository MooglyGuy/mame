...
// +--------------------+
hp_ipc_optrom_device::hp_ipc_optrom_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock)
...
std::pair<std::error_condition, std::string> hp_ipc_optrom_device::call_load()
{
