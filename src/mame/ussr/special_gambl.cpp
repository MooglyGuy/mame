...
static INPUT_PORTS_START(dice)
	...
	PORT_BIT(0x80, IP_ACTIVE_HIGH, IPT_CUSTOM) PORT_CUSTOM_MEMBER(FUNC(dinaris_state::boot_r))
	...
	PORT_START("NMI")
	PORT_BIT(0x01, IP_ACTIVE_HIGH, IPT_SERVICE3) PORT_NAME("RAM Test") PORT_CHANGED_MEMBER(DEVICE_SELF, FUNC(dinaris_state::ram_test), 0)
INPUT_PORTS_END
