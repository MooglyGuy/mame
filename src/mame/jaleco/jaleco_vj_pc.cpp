...
jaleco_vj_pc_device::jaleco_vj_pc_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock) :
...
void jaleco_vj_pc_device::device_add_mconfig(machine_config &config)
{
	...
	PENTIUM(config, m_maincpu, XTAL::u(20'000'000)); // TODO: Pentium 60/90mhz? Underclocked for performance reasons
	...
	PCI_ROOT(config, "pci");
	I82439HX(config, "pci:00.0", m_maincpu, 256*1024*1024); // TODO: Should be 0x05851106 VIA VT82C585 Apollo VP,VPX,VPX-97 System Controller
