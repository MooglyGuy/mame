...
GAME( 199?, pr_lday,    0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "'L' Of A Day (Project) (Cash set) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_ldaya,   pr_lday,    proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "'L' Of A Day (Project) (Token set) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_5xcsh,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "5x Cash (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_7hvn,    0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "777 Heaven (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_7hvna,   pr_7hvn,    proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "777 Heaven (Project) (10GBP Jackpot) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_7hvnb,   pr_7hvn,    proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "777 Heaven (Project) (20p 6GBP Jackpot Version 114) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_7hvnc,   pr_7hvn,    proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "777 Heaven (Project) (10p 3GBP Jackpot Version 380) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_7hvnd,   pr_7hvn,    proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "777 Heaven (Project) (5p 3GBP Jackpot Version 105) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_7hvne,   pr_7hvn,    proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "777 Heaven (Project) (set 6) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_7hvnf,   pr_7hvn,    proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "777 Heaven (Project) (set 7) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_7hvng,   pr_7hvn,    proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "777 Heaven (Project) (set 8) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_7hvnh,   pr_7hvn,    proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "777 Heaven (Project) (set 9) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_7hvni,   pr_7hvn,    proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "777 Heaven (Project) (set 10) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_7hvnj,   pr_7hvn,    proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "777 Heaven (Project) (set 11) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_7hvnk,   pr_7hvn,    proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "777 Heaven (Project) (set 12) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_7hvnl,   pr_7hvn,    proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "777 Heaven (Project) (set 13) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_7hvnm,   pr_7hvn,    proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "777 Heaven (Project) (set 14) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_7hvnn,   pr_7hvn,    proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "777 Heaven (Project) (set 15) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_7hvno,   pr_7hvn,    proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "777 Heaven (Project) (set 16) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_7hvnp,   pr_7hvn,    proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "777 Heaven (Project) (set 17) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_7hvnq,   pr_7hvn,    proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "777 Heaven (Project) (set 18) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_7hvnr,   pr_7hvn,    proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "777 Heaven (Project) (set 19) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_7hvns,   pr_7hvn,    proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "777 Heaven (Project) (set 20) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_7hvnt,   pr_7hvn,    proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "777 Heaven (Project) (set 21) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_7hvnu,   pr_7hvn,    proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "777 Heaven (Project) (set 22) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )

GAME( 199?, pr_alwy9,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "PCP"    , "Always Nine (Pcp) (set 1) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_alwy9a,  pr_alwy9,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "PCP"    , "Always Nine (Pcp) (set 2) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_barbl,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Bars & Bells (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_batls,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Battleships (Project) (set 1) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_batlsa,  pr_batls,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Battleships (Project) (set 2) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_batlsb,  pr_batls,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Battleships (Project) (set 3) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_btwar,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Beat The Warden (Project) (set 1) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_btwara,  pr_btwar,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Beat The Warden (Project) (set 2) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_btwarb,  pr_btwar,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Beat The Warden (Project) (set 3) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_bigdp,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Big Dipper (Project) (set 1) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_bigdpa,  pr_bigdp,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Big Dipper (Project) (set 2) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_bulls,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Bullseye (Project) (set 1) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_bullsa,  pr_bulls,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Bullseye (Project) (set 2) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_bullsb,  pr_bulls,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Bullseye (Project) (set 3) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_bulbn,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Bully's Big Night (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_bulbna,  pr_bulbn,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Bully's Big Night (Project) (set 1) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_bulbnb,  pr_bulbn,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Bully's Big Night (Project) (set 2) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_buljp,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Bully's Jackpot (Project) (set 1) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_buljpa,  pr_buljp,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Bully's Jackpot (Project) (set 2) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_cashb,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Cash Back (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_cas7,    0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Casino Jackpot 7s (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_chico,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Chico the Bandit (Project) (set 1) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_chicoa,  pr_chico,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Chico the Bandit (Project) (set 2) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_chicob,  pr_chico,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Chico the Bandit (Project) (set 3) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_coolm,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Cool Million (Project) (set 1) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_coolma,  pr_coolm,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Cool Million (Project) (set 2) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_coolmb,  pr_coolm,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Cool Million (Project) (set 3) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_crz77,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Crazy 777s (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_crzbr,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Crazy Bars (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_supbr,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "PCP",     "Super Bars (PCP) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )

GAME( 199?, pr_coyot,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "PCP"    , "Crazy Coyote (Pcp) (10p) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_coyota,  pr_coyot,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "PCP"    , "Crazy Coyote (Pcp) (20p) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )

GAME( 199?, pr_crzpy,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Crazy Pays (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_dblup,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Double Up (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_fire,    0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Fircecracker (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_flshc,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Flash The Cash (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_ftwhl,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Fortune Wheel (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_funrn,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Fun On The Run (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_gogld,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Go For Gold (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_gldnl,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Golden Nile (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_gldng,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Golden Nugget (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_gdft,    0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Good Fortune (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_happy,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Happy Days (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_heato,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "The Heat Is On (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_hiclm,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Hi Climber (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_hit6,    0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Hit The Six (Project) (set 1) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_hit6a,   pr_hit6,    proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Hit The Six (Project) (set 2) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_hit6b,   pr_hit6,    proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Hit The Six (Project) (set 3) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_hotcs,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Hot Cash (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_hotsp,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Hot Spots (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_jkpt7,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Jackpot 7's (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_jkrwd,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Jokers Wild (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_jumpj,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Jumping Jacks (Project) (set 1) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_jumpja,  pr_jumpj,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Jumping Jacks (Project) (set 2) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_medl,    0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Medalist (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_megmn,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Mega Money (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_nudxs,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Nudge XS (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_qksht,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Maygay", "Quickshot (Maygay) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_rags,    0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Rags To Riches (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_reflx,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Reflex (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_roadr,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Road Riot (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_roll,    0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "The Roll (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_sevab,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Seven's Above (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_sevml,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Sevens & Melons (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_theme,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Theme Park (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_ttrai,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Treasure Trail (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_trpx,    0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Triple X (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 1999, pr_trktr,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Trick or Treat (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 1999, pr_trktp,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Trick or Treat (Protocol?) (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_walls,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Wall Street (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_whlft,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Wheel Of Fortune (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_wldkn,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Wild Kings (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_nifty,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Nifty Fifty (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_upnun,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Project", "Up & Under (Project) (PROCONN)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_sptb,    0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Pcp", "Simply the Best (Pcp) (PROCONN?)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK ) // not 100% sure this belongs here

// Some of these are PC98 hardware.. I don't know how / if that differs
GAME( 199?, pr_bears,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Coinworld", "Bear Streak (set 1) (Coinworld)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_bearsa,  pr_bears,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Coinworld", "Bear Streak (set 2) (Coinworld)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_bearsb,  pr_bears,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Coinworld", "Bear Streak (set 3) (Coinworld)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_bearx,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Coinworld", "Bear X (Version 2.3) (Coinworld)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_bearxa,  pr_bearx,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Coinworld", "Bear X (Version 2.2) (Coinworld)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_bearxb,  pr_bearx,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Coinworld", "Bear X (Version 1.3) (Coinworld)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_bearxc,  pr_bearx,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Coinworld", "Bear X (20p set 1) (Coinworld)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_bearxd,  pr_bearx,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Coinworld", "Bear X (20p set 2) (Coinworld)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_bearxe,  pr_bearx,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Coinworld", "Bear X (10p set 1) (Coinworld)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_bearxf,  pr_bearx,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Coinworld", "Bear X (10p set 2) (Coinworld)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_bearxg,  pr_bearx,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Coinworld", "Bear X (10p set 3) (Coinworld)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_bearxh,  pr_bearx,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Coinworld", "Bear X (10p set 4?) (Coinworld)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_bearxi,  pr_bearx,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Coinworld", "Bear X (10p set 5) (Coinworld)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_bearxj,  pr_bearx,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Coinworld", "Bear X (code 813) (Coinworld)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_bearxk,  pr_bearx,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Coinworld", "Bear X (8GBP Token?) (Coinworld)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_bearxl,  pr_bearx,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Coinworld", "Bear X (Version 41) (Coinworld)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_bearxlp, pr_bearx,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Coinworld", "Bear X (Version 41, Protocol) (Coinworld)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_bearxm,  pr_bearx,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Coinworld", "Bear X (Version 31) (Coinworld)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )

GAME( 199?, pr_fspot,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Coinworld", "Fun Spot (Version 4.1) (Coinworld)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_fspota,  pr_fspot,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Coinworld", "Fun Spot (Version 3.1) (Coinworld)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_fspotb,  pr_fspot,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Coinworld", "Fun Spot (Version 2.1, set 1) (Coinworld)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_fspotc,  pr_fspot,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Coinworld", "Fun Spot (Version 2.1, 20p stake, 82%) (Coinworld)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_fspotd,  pr_fspot,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Coinworld", "Fun Spot (Version 2.1, 7 button) (Coinworld)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_fspote,  pr_fspot,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Coinworld", "Fun Spot (Version 1.1, set 1) (Coinworld)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_fspotf,  pr_fspot,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Coinworld", "Fun Spot (Version 1.1, 20p stake, 82%) (Coinworld)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_fspotg,  pr_fspot,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Coinworld", "Fun Spot (Version 1.1, 6 button) (Coinworld)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )

GAME( 199?, pr_gnuc,    0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Coinworld", "Golden Nugget (Version 2.2) (Coinworld)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_gnuca,   pr_gnuc,    proconn,    proconn,     proconn_state, init_proconn, ROT0, "Coinworld", "Golden Nugget (Version 1.2) (Coinworld)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_magln,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Coinworld", "Magic Lines (Version 2.1) (Coinworld)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_maglna,  pr_magln,   proconn,    proconn,     proconn_state, init_proconn, ROT0, "Coinworld", "Magic Lines (Version 1.1) (Coinworld)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_wnstk,   0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Coinworld", "Winning Streak (Version 1.1) (Coinworld)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
GAME( 199?, pr_swop,    0,          proconn,    proconn,     proconn_state, init_proconn, ROT0, "Ace", "Swop It (Ace)",MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK )
