...
{
	PENTIUM2(config, m_maincpu, XTAL::u(100'000'000)); // Celeron, downclocked for debugging
	...
	P87C552(config, "iocpu", XTAL::u(16'000'000)).set_disable();
	...
	ISA16_SLOT(config, "board4", "pci:07.0:isabus", isa_internal_devices, "fdc37m707", true).set_option_machine_config("fdc37m707", superio_config);
...
#if 1
	VOODOO_2_PCI(config, m_voodoo2, m_maincpu, "screen"); // "pci:0d.0" J4D2
...
{
	PENTIUM3(config, m_maincpu, XTAL::u(100'000'000)); // downclocked for debugging
