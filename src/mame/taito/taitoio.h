...
{
public:
	tc0040ioc_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock = XTAL());
...
{
public:
	tc0220ioc_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock = XTAL());
...
{
public:
	tc0510nio_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock = XTAL());
...
{
public:
	tc0640fio_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock = XTAL());
