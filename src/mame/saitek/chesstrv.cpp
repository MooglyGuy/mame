...
void chesstrv_state::chesstrvi(machine_config &config)
{
	...
	// basic machine hardware
	m_maincpu->set_clock(XTAL::u(6'000'000)/2); // approximation
	subdevice<f38t56_device>("psu")->set_clock(XTAL::u(6'000'000)/2);
