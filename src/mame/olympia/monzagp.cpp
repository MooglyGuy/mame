...
void monzagp_state::monzagp(machine_config &config)
{
	...
	screen.set_raw(XTAL::u(10'920'000), 700, 0, 560, 312, 11, 240); // 11-line offset makes attract mode look symmetric
	screen.set_screen_update(FUNC(monzagp_state::screen_update));
	screen.set_palette(m_palette);

	DP8350(config, m_crtc, XTAL::u(10'920'000)); // pins 21/22 connected to XTAL, 3 to GND, 5 to +5
