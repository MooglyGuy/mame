...
{
	Z80(config, m_maincpu, /*XTAL::u(6000000)*/ XTAL::u(4606000));        /* Russell Marks says this is more accurate */
	...
	clock_device &uart_clock(CLOCK(config, "uart_clock", XTAL::u(150) * 16));
