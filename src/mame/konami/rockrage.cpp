...
void rockrage_state::rockrage(machine_config &config)
{
	...
	K007342(config, m_k007342, m_palette, gfx_rockrage_tiles);
	...
	K007420(config, m_k007420, m_palette, gfx_rockrage_spr);
	...
	YM2151(config, "ymsnd", XTAL::u(3'579'545)).add_route(0, "speaker", 0.30, 0).add_route(1, "speaker", 0.30, 1);
