...
void gx400_state::nemesis(machine_config &config)
{
	...
	M68000(config, m_maincpu, XTAL::u(18'432'000)/2); /* 9.216 MHz? */
//  14318180/2, /* From schematics, should be accurate */
	m_maincpu->set_addrmap(AS_PROGRAM, &gx400_state::nemesis_map);

	Z80(config, m_audiocpu, XTAL::u(14'318'180)/8); /* 1.7897725MHz */
	...
	ay8910_device &ay1(AY8910(config, "ay1", XTAL::u(14'318'180)/8));
	...
	ay8910_device &ay2(AY8910(config, "ay2", XTAL::u(14'318'180)/8));
	...
	K005289(config, m_k005289, XTAL::u(3'579'545));
...
{
	/* basic machine hardware */
	M68000(config, m_maincpu, XTAL::u(18'432'000)/2); /* 9.216MHz */
...
void salamand_state::salamand(machine_config &config)
{
	...
	Z80(config, m_audiocpu, XTAL::u(3'579'545)); /* 3.579545 MHz */
	...
	K007232(config, m_k007232, XTAL::u(3'579'545));
...
void hcrash_state::citybomb(machine_config &config)
{
	...
	ym3812_device &ym3812(YM3812(config, "ymsnd", XTAL::u(3'579'545)));
//  ym3812.irq_handler().set_inputline("audiocpu", 0); ... Interrupts _are_ generated, I wonder where they go
	...
	k051649_device &k051649(K051649(config, "k051649", XTAL::u(3'579'545)));
...
{
	/* basic machine hardware */
	M68000(config, m_maincpu, XTAL::u(18'432'000)/3); /* 6.144MHz */
	...
	Z80(config, m_audiocpu, XTAL::u(14'318'180)/4); /* 3.579545 MHz */
