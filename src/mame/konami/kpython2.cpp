...
GAME(2005, kpython2, 0, kpython2, kpython2, kpython2_state, empty_init, ROT0, "Konami", "Konami Python 2 BIOS", MACHINE_NO_SOUND | MACHINE_NOT_WORKING|MACHINE_IS_BIOS_ROOT)

GAME(2005, dance864, kpython2, kpython2, dance864, kpython2_state, empty_init, ROT0, "Konami", "DANCE 86.4 FUNKY RADIO STATION (E01:J:A:A:2005040400)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)

GAME(2006, ddrsnj,   kpython2, kpython2, ddr, kpython2_state, empty_init, ROT0, "Konami", "Dance Dance Revolution SuperNOVA (FDH:J:A:A:2006090600)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)
GAME(2006, ddrsna,   kpython2, kpython2, ddr, kpython2_state, empty_init, ROT0, "Konami", "Dance Dance Revolution SuperNOVA (FDH:A:A:A:2006071300)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)
GAME(2006, ddrsnu,   kpython2, kpython2, ddr, kpython2_state, empty_init, ROT0, "Konami", "Dance Dance Revolution SuperNOVA (FDH:U:A:A:2006072400)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)
GAME(2007, ddrsn2j,  kpython2, kpython2, ddr, kpython2_state, empty_init, ROT0, "Konami", "Dance Dance Revolution SuperNOVA 2 (GDJ:J:A:A:2007100800)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)
GAME(2007, ddrsn2ja, ddrsn2j,  kpython2, ddr, kpython2_state, empty_init, ROT0, "Konami", "Dance Dance Revolution SuperNOVA 2 (GDJ:J:A:A:2007071100)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)
GAME(2007, ddrsn2a,  kpython2, kpython2, ddr, kpython2_state, empty_init, ROT0, "Konami", "Dance Dance Revolution SuperNOVA 2 (GDJ:A:A:A:2007100800)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)
GAME(2007, ddrsn2aa, ddrsn2a,  kpython2, ddr, kpython2_state, empty_init, ROT0, "Konami", "Dance Dance Revolution SuperNOVA 2 (GDJ:A:A:A:2007071100)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)
GAME(2007, ddrsn2u,  kpython2, kpython2, ddr, kpython2_state, empty_init, ROT0, "Konami", "Dance Dance Revolution SuperNOVA 2 (GDJ:U:A:A:2007100800)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)

GAME(2006, dstagesn,  kpython2, kpython2, ddr, kpython2_state, empty_init, ROT0, "Konami", "Dancing Stage SuperNOVA (FDH:E:A:A:2006072500)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)
GAME(2006, dstagesna, dstagesn, kpython2, ddr, kpython2_state, empty_init, ROT0, "Konami", "Dancing Stage SuperNOVA (FDH:E:A:A:2006032200)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)

GAME(2005, drmnvj,   kpython2, kpython2, drmn, kpython2_state, empty_init, ROT0, "Konami", "DrumMania V (E02:J:A:A:2005050200)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)
GAME(2006, drmnv2j,  kpython2, kpython2, drmn, kpython2_state, empty_init, ROT0, "Konami", "DrumMania V2 (F02:J:A:A:2006011201)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)
GAME(2005, drmnv2ja, drmnv2j,  kpython2, drmn, kpython2_state, empty_init, ROT0, "Konami", "DrumMania V2 (F02:J:A:A:2005112800)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)
GAME(2005, drmnv2jb, drmnv2j,  kpython2, drmn, kpython2_state, empty_init, ROT0, "Konami", "DrumMania V2 (F02:J:A:A:2005101600)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)
GAME(2006, drmnv3j,  kpython2, kpython2, drmn, kpython2_state, empty_init, ROT0, "Konami", "DrumMania V3 (F32:J:A:A:2006101800)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)
GAME(2006, drmnv3ja, drmnv3j,  kpython2, drmn, kpython2_state, empty_init, ROT0, "Konami", "DrumMania V3 (F32:J:A:A:2006072600)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)
GAME(2005, drmnva,   kpython2, kpython2, drmn, kpython2_state, empty_init, ROT0, "Konami", "DrumMania V (E02:A:A:A:2005050200)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)
GAME(2006, drmnv2a,  kpython2, kpython2, drmn, kpython2_state, empty_init, ROT0, "Konami", "DrumMania V2 (F02:A:A:A:2006011201)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)
GAME(2005, drmnv2aa, drmnv2a,  kpython2, drmn, kpython2_state, empty_init, ROT0, "Konami", "DrumMania V2 (F02:A:A:A:2005112800)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)
GAME(2005, drmnv2ab, drmnv2a,  kpython2, drmn, kpython2_state, empty_init, ROT0, "Konami", "DrumMania V2 (F02:A:A:A:2005101600)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)
GAME(2006, drmnv3a,  kpython2, kpython2, drmn, kpython2_state, empty_init, ROT0, "Konami", "DrumMania V3 (F32:A:A:A:2006101800)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)
GAME(2006, drmnv3aa, drmnv3a,  kpython2, drmn, kpython2_state, empty_init, ROT0, "Konami", "DrumMania V3 (F32:A:A:A:2006072600)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)

GAME(2005, gtrfrkvj,   kpython2,  kpython2, gtrfrks, kpython2_state, empty_init, ROT0, "Konami", "Guitar Freaks V (E03:J:A:A:2005050200)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)
GAME(2006, gtrfrkv2j,  kpython2,  kpython2, gtrfrks, kpython2_state, empty_init, ROT0, "Konami", "Guitar Freaks V2 (F03:J:A:A:2006011201)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)
GAME(2005, gtrfrkv2ja, gtrfrkv2j, kpython2, gtrfrks, kpython2_state, empty_init, ROT0, "Konami", "Guitar Freaks V2 (F03:J:A:A:2005112800)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)
GAME(2005, gtrfrkv2jb, gtrfrkv2j, kpython2, gtrfrks, kpython2_state, empty_init, ROT0, "Konami", "Guitar Freaks V2 (F03:J:A:A:2005101600)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)
GAME(2006, gtrfrkv3j,  kpython2,  kpython2, gtrfrks, kpython2_state, empty_init, ROT0, "Konami", "Guitar Freaks V3 (F33:J:A:A:2006101800)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)
GAME(2006, gtrfrkv3ja, gtrfrkv3j, kpython2, gtrfrks, kpython2_state, empty_init, ROT0, "Konami", "Guitar Freaks V3 (F33:J:A:A:2006072600)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)
GAME(2005, gtrfrkva,   kpython2,  kpython2, gtrfrks, kpython2_state, empty_init, ROT0, "Konami", "Guitar Freaks V (E03:A:A:A:2005050200)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)
GAME(2006, gtrfrkv2a,  kpython2,  kpython2, gtrfrks, kpython2_state, empty_init, ROT0, "Konami", "Guitar Freaks V2 (F03:A:A:A:2006011201)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)
GAME(2005, gtrfrkv2aa, gtrfrkv2a, kpython2, gtrfrks, kpython2_state, empty_init, ROT0, "Konami", "Guitar Freaks V2 (F03:A:A:A:2005112800)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)
GAME(2005, gtrfrkv2ab, gtrfrkv2a, kpython2, gtrfrks, kpython2_state, empty_init, ROT0, "Konami", "Guitar Freaks V2 (F03:A:A:A:2005101600)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)
GAME(2006, gtrfrkv3a,  kpython2,  kpython2, gtrfrks, kpython2_state, empty_init, ROT0, "Konami", "Guitar Freaks V3 (F33:A:A:A:2006101800)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)
GAME(2006, gtrfrkv3aa, gtrfrkv3a, kpython2, gtrfrks, kpython2_state, empty_init, ROT0, "Konami", "Guitar Freaks V3 (F33:A:A:A:2006072600)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)

GAME(2005, thrild3j, kpython2, kpython2, thrild3, kpython2_state, empty_init, ROT0, "Konami", "Thrill Drive 3 (D44:J:A:A:20050316)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)

GAME(2005, toysmarch,  kpython2, kpython2, toysmarch, kpython2_state, empty_init, ROT0, "Konami", "Toy's March (E00:J:A:A:2005011602)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)
GAME(2005, toysmarch2, kpython2, kpython2, toysmarch, kpython2_state, empty_init, ROT0, "Konami", "Toy's March 2 (F00:J:A:A:2005110400)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)
