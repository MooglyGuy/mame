...
function osdmodulesbuild()
	...
	files {
		...
		MAME_DIR .. "src/osd/modules/render/bgfx/effectentry.cpp",
		MAME_DIR .. "src/osd/modules/render/bgfx/effectentry.h",
		MAME_DIR .. "src/osd/modules/render/bgfx/effectmanager.cpp",
		MAME_DIR .. "src/osd/modules/render/bgfx/effectmanager.h",
		MAME_DIR .. "src/osd/modules/render/bgfx/entryuniform.cpp",
		MAME_DIR .. "src/osd/modules/render/bgfx/entryuniform.h",
		...
		MAME_DIR .. "src/osd/modules/render/bgfx/parameter.h",
		MAME_DIR .. "src/osd/modules/render/bgfx/paramuniform.cpp",
		MAME_DIR .. "src/osd/modules/render/bgfx/paramuniform.h",
		MAME_DIR .. "src/osd/modules/render/bgfx/shader.cpp",
		MAME_DIR .. "src/osd/modules/render/bgfx/shader.h",
		MAME_DIR .. "src/osd/modules/render/bgfx/shaderprogmanager.cpp",
		MAME_DIR .. "src/osd/modules/render/bgfx/shaderprogmanager.h",
